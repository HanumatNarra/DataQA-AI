...
export default function Footer() {
  return (
    <footer className="bg-[var(--surface)] border-t border-[var(--line)] py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-[var(--text)]">DataQA.ai</span>
            </div>
            <p className="text-[var(--text-muted)] mb-4 max-w-md">
              Ask questions about your data in plain English. Get instant answers and charts—no SQL required.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-[var(--line)]">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-[var(--text-muted)] text-sm">
              © 2024 DataQA.ai. All rights reserved.
            </p>
